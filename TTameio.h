...
int TameioFree(TTameio tameio);		//elegxei an einai diathesimo

int TameioGetArithmosPelatwn(TTameio tameio);	//epistrefei ton arithmo pelatwn
...
int TameioGetEnapomenonXronos(TTameio tameio);	//epistrefei ton enapomenanta xrono
